...
export interface IdentityConfig<T extends IdentityOptions> {
...
export class IdentityColumnDefinition<
  ...
  TIdentity extends IdentityConfig<IdentityOptions>,
> extends ColumnDefinition<
  TName,
  Omit<ColumnConfig<number, string>, "identity"> & { identity: TIdentity }
> {
  protected override _identity: ColumnIdentityConfig;

  constructor(
    name: TName,
    config: Partial<Omit<ColumnConfig<number, string>, "identity"> & { identity: TIdentity }>
  ) {
    super(name, config);
...
export function identity<const TName extends string, const TOptions extends IdentityOptions>(
  name: TName,
  options?: TOptions
) {
  const identity = {
